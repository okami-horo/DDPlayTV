...
class LogFormatterTest {
    ...
    fun formatProducesStructuredLine() {
        ...
        assertTrue(line.contains("context={errorCode=E001,scene=playback}"))
        assertTrue(line.contains("throwable="))
        assertTrue(line.contains("message=\"renderer failed retrying\""))
    }
    ...
    fun formatForLogcatIsCompact() {
        ...
        assertTrue(logcat.startsWith("WARN/core [core:Shell] #5: line1 line2"))
        assertTrue(logcat.contains("{scene=boot,stage=init}"))
    }
