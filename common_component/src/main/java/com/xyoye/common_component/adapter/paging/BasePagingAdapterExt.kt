...
fun <T : Any> buildPagingAdapter(init: BasePagingAdapter<T>.() -> Unit): BasePagingAdapter<T> = BasePagingAdapter<T>().apply { init() }

fun <T : Any> BasePagingAdapter<T>.initData(
    lifecycle: Lifecycle,
...
inline fun <reified T : Any, V : ViewDataBinding> BasePagingAdapter<T>.addItem(
    resourceId: Int,
