...
class AdapterDiffCallBack(
    ...
    override fun areItemsTheSame(
        oldItemPosition: Int,
        newItemPosition: Int
    ): Boolean = diffCreator.isSameItem(oldData[oldItemPosition], newData[newItemPosition])

    override fun areContentsTheSame(
        oldItemPosition: Int,
        newItemPosition: Int
    ): Boolean = diffCreator.isSameContent(oldData[oldItemPosition], newData[newItemPosition])
}
