...
class Media3PlaybackSmokeTest {
    ...
    @Test
    fun firstFrameWithinTwoSeconds_passesSmokeBudget() = runBlocking {
    ...
    private class FakeSessionController : Media3SessionController() {
        override suspend fun prepareSession(
            ...
            return Result.success(sessionBundle(sessionId = "session-$mediaId", mediaId = mediaId))
        }
    }
...
private fun snapshot(value: Boolean, now: Long): RolloutToggleSnapshot {
