...
public class NumberPicker extends LinearLayout {
    ...
    public NumberPicker(Context context, AttributeSet attrs, int defStyle) {
        ...
        // input text
        mInputText = (EditText) findViewById(R.id.date_picker_et);
...
//            mInputText.setVisibility(View.INVISIBLE);
    ...
    private void updateInputTextView() {
        ...
        if (!TextUtils.isEmpty(text) && !text.equals(mInputText.getText().toString())) {
            if (mDisplayedValues == null) {
                mInputText.setText(sTwoDigitFormatter.format(Integer.parseInt(text)) + label);
            } else {
    ...
    class SupportAccessibilityNodeProvider {
        ...
        public void performAction(int virtualViewId, int action, Bundle arguments) {
            if (mProvider != null) {
                mProvider.performAction(virtualViewId, action, arguments);
            }
